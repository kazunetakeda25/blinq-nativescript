<template>
  <StackLayout orientation="horizontal" @tap="showCountriesModal">
    ...
    <FlexboxLayout class="name-container" alignItems="center">
      <Label v-if="isShowLabel" :color="textColor" class="name-display font-roboto-medium" :minWidth="$responsiveUI.scale(50)" :text="itemSelected && itemSelected.Code.toUpperCase() || ''" />
    </FlexboxLayout>
...
export default {
  ...
  computed: {
    itemSelected() {
      ...
      console.log(JSON.stringify(this.itemSelect));
